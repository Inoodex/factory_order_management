            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select id="designation" name="designation" class="form-input @error('designation') is-invalid @enderror">
                        ...
                        <option value="senior" {{ old('designation', $editUser->designation) == 'senior' ? 'selected' : '' }}>Senior</option>
                        <option value="junior" {{ old('designation', $editUser->designation) == 'junior' ? 'selected' : '' }}>Junior</option>
                    </select>
                    @error('designation')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
